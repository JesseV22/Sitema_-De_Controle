    ...
    <div class="container right-panel-active" id="container">
        <div class="form-container sign-up-container">
            <form method="POST" action="{{ route('register') }}">
                ...
                <input type="text" name="name" placeholder="Nome" required value="{{ old('name') }}" autofocus autocomplete="name" />
                <input type="email" name="email" placeholder="Email" required value="{{ old('email') }}" />
                <input type="password" name="password" placeholder="Senha" required autocomplete="new-password" />
                <input type="password" name="password_confirmation" placeholder="Confirme a Senha" required autocomplete="new-password" />
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <a href="{{ route('login.form') }}"><button class="ghost" id="signIn">Entrar</button></a>
                </div>
